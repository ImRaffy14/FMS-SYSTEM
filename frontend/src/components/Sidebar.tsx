...
function Sidebar() {
  ...
  const adminMenuItems = [
    { id: "coursesAndSubjects", path: "/coursesAndSubject", icon: <LandPlot size={20} />, label: "Courses and Subjects" },
    { id: "roomManagement", path: "/roomManagement", icon: <School size={20} />, label: "Room Management" },
    { id: "facultyMonitoring", path: "/facultyMonitoring", icon: <Airplay size={20} />, label: "Faculty Monitoring" },
    { id: "facultyLoadingSchedule", path: "/facultyLoadingSchedule", icon: <CalendarCheck size={20} />, label: "Faculty Loading Schedule" },
